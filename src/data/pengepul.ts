...
export const pengepul: Pengepul[] = [
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Endang Suhendang berlokasi di Blok Jumat, RT 03/RW 01, Desa Leuwilaja dan telah beroperasi kurang lebih 10-11 tahun. Selama puluhan tahun beliau memproduksi berbagai produk, salah satunya Rotan basket, Kubu grey. Hingga saat ini usaha tersebut dikelola bersama 13 orang pekerja dan tetap menjadi bagian dari aktivitas industri rotan di Desa Leuwilaja.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Eme Atma telah berjalan sejak tahun 2010 dan berlokasi di Blok Senin, RT 04/RW 02. Produksi difokuskan pada berbagai jenis keranjang rotan dengan kisaran harga Rp20.000 hingga Rp70.000, tergantung ukuran produk. Saat ini usaha tersebut didukung sekitar 20 orang pekerja.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Eman (Suherman) telah berdiri sejak tahun 1992 dan memproduksi berbagai jenis basket rotan serta keranjang rotan. Harga produk disesuaikan dengan ukuran yang dipesan dan proses produksi melibatkan sekitar 7 orang pekerja.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Subana berlokasi di Blok Senin Tagog, RT 04. Produksi utamanya berupa keranjang rotan dengan kisaran harga Rp21.000–Rp25.000. Saat ini usaha tersebut didukung sekitar 25 orang pekerja.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Ayud telah berjalan selama kurang lebih 30–32 tahun. Produksi berfokus pada pembuatan keranjang rotan yang dipasarkan dengan harga sekitar Rp20.000–Rp25.000 per buah. Proses produksi melibatkan sekitar 6 orang pekerja.",
    produk: ["Keranjang Rotan"],
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Nanang berada di Blok Rabu, RT 07 dan memproduksi berbagai jenis keranjang rotan. Produk yang dihasilkan telah dipasarkan hingga ke luar daerah. Dalam kegiatan produksinya usaha ini didukung sekitar 15 orang pekerja.",
    produk: ["Keranjang Rotan"],
    harga: "-",
    telepon: "-",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Asmar telah berjalan selama kurang lebih 15 tahun.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Johar telah berjalan sekitar 25 tahun dan berlokasi di sekitar SD wilayah RT 09. Produk dipasarkan dengan kisaran harga Rp40.000–Rp69.000 dan melibatkan lebih dari 100 pengrajin.",
    produk: ["Produk Kerajinan Rotan"],
  ...
  },
  {
    ...
    deskripsi: "Gudang kedua milik Emon Suherman berlokasi di Blok Kemis, RT 11/RW 05 dan memiliki aktivitas produksi yang sama dengan Gudang 1. Berbagai jenis produk rotan diproduksi untuk memenuhi kebutuhan pasar dengan dukungan lebih dari 100 pekerja.",
    produk: ["Biholma", "Drey", "Trumis", "Ester", "Tok Ning", "Ban", "Setebel", "Laci", "Kursi Rotan"],
    harga: "Rp 22.000 – Rp 142.000",
    telepon: "-",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Jaenudin berfokus pada produksi potato. Sistem pembayaran dilakukan berdasarkan hasil pekerjaan atau sistem borongan.",
    produk: ["Potato"],
    harga: "-",
    telepon: "-",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Asep Priyanto menghasilkan berbagai produk kerajinan rotan mulai dari keranjang, laci, hingga souvenir custom. Produk unggulannya adalah laci penyimpanan dengan kisaran harga mulai Rp7.000 hingga Rp350.000. Proses produksi didukung sekitar 20 orang pekerja.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Arif telah berdiri sejak tahun 2007 dan menghasilkan berbagai jenis produk rotan yang telah memenuhi standar ekspor. Produk yang diproduksi memiliki variasi model dengan kisaran harga mulai Rp90.000 hingga sekitar Rp400.000.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Nana berfokus sebagai pengepul dengan produk utama berupa laundry basket dan keranjang parcel. Produk yang dihasilkan selanjutnya disetorkan ke pabrik sehingga informasi harga tidak tersedia. Usaha ini mulai berjalan pada awal tahun 2025 dengan dukungan 5 orang pekerja.",
  ...
  },
  {
    ...
    deskripsi: "Usaha milik Onong, yang dikenal dengan nama Saung Rotan, berlokasi di RT 16/RW 07 Blok Sabtu. Usaha ini didukung oleh 3 orang pekerja dan menjadi salah satu pelaku usaha rotan di wilayah tersebut.",
